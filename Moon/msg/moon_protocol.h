...
////////////////////////////////////////连接初始化消息///////////////////////////////////////////////
#define MN_PROTOCOL_MAIN_CONNECT_ROUTER_INIT 20001  //连接路由服务初始化消息
#define MN_PROTOCOL_SUB_MOON_TO_ROTUER 2000102 //通信服务器连接到路由服务的初始化消息
#define MN_PROTOCOL_SUB_ROUTER_ACCEPT 2000103 //路由服务接受连接的子协议
#define MN_PROTOCOL_SUB_ROUTER_REFUSE 2000104 //路由服务拒绝连接的子协议
